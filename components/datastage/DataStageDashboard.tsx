...
import { DollarSign, Package, TrendingUp, TrendingDown, Search, Cpu, Table, BarChart3, FileText, ChevronRight, Share2, FileDown } from 'lucide-react';
                    ...
                    {filteredData.slice(0, 50).map((row) => (
                        ...
                        <td className="px-6 py-3">
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                                row.tipoOperacion === '1' ? 'bg-green-100 text-green-700' : 'bg-orange-100 text-orange-700'
                            }`}>
