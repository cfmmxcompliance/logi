...
export const translations: Translations = {
    ...
    "truck.buscar": { es: "Buscar por operador, DRY VAN (Trailer), tractor o OPERATION (separados por comas)...", en: "Search by driver, DRY VAN (Trailer), tractor or OPERATION (comma separated)...", zh: "搜索司机、干货车 (Trailer)、牵引车或操作 (逗号分隔)..." },
    ...
    "truck.col.hora": { es: "APPOINTMENT", en: "APPOINTMENT", zh: "时间" },
    "truck.col.driver_arrival": { es: "DRIVER ARRIVAL", en: "DRIVER ARRIVAL", zh: "司机到达" },
    ...
    "truck.col.creado_por": { es: "CREADO POR", en: "CREATED BY", zh: "创建者" },
    "truck.col.creado_at": { es: "CREATED", en: "CREATED", zh: "创建时间" },
    "truck.col.layout_por": { es: "LAYOUT POR", en: "LAYOUT BY", zh: "布局者" },
    ...
    "truck.col.lib_fecha": { es: "FECHA LIBERACIÓN", en: "RELEASE DATE", zh: "发布日期" },
    ...
    "truck.col.t_layout": { es: "T.LAYOUT", en: "LAYOUT TIME", zh: "布局时间" },
    "truck.col.t_ccp": { es: "T.CCP", en: "CCP TIME", zh: "CCP时间" },
