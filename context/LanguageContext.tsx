...
export const translations: Translations = {
    ...
    "col.caja": { es: "Caja", en: "Dry Van", zh: "车厢号" },
    ...
    "col.layout": { es: "LAYOUT", en: "LAYOUT", zh: "运单制作" },
    ...
    "col.dock": { es: "DOCK", en: "DOCK", zh: "装卸口" },
    ...
    "filter.por_cerrar": { es: "POR CERRAR", en: "PENDING", zh: "装运中" },
    "filter.cerrado": { es: "CERRADO", en: "CLOSED", zh: "已发运" },
