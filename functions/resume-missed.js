...
async function run() {
    ...
    console.log("🚀 Resuming extraction and rename of the FINAL 15 missed anomalous ZIPs...");
    ...
    for (const dipc of dipcFolders) {
        ...
        for (const mc of mcFolders) {
            // ONLY pick up the strictly un-renamed folders
            ...
            // Find anomalous nested zips that were unextracted
